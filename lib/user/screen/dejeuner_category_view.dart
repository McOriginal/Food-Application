...
class DejeunerView extends StatefulWidget {
  const DejeunerView({super.key});

  @override
  State<DejeunerView> createState() => _DejeunerViewState();
}

class _DejeunerViewState extends State<DejeunerView> {
  // ***************************
  bool isFavorite = false;

  final Stream<QuerySnapshot> _productsStream = FirebaseFirestore.instance
      .collection('produits')
      .where('category', isEqualTo: 'Déjeuner')
      .snapshots();
