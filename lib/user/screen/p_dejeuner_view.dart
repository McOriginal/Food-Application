...
class PetitDejeunerView extends StatefulWidget {
  const PetitDejeunerView({super.key});

  @override
  State<PetitDejeunerView> createState() => _PetitDejeunerViewState();
}

class _PetitDejeunerViewState extends State<PetitDejeunerView> {
  // ***************************
  bool isFavorite = false;

  final Stream<QuerySnapshot> _productsStream = FirebaseFirestore.instance
      .collection('produits')
      .where('category', isEqualTo: 'Petit Déjeuner')
      .snapshots();
